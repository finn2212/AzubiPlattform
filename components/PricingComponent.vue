<template>
    <div class="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div class="mx-auto max-w-4xl text-center">
        <h2 class="text-base/7 font-semibold text-indigo-600">Preise</h2>
        <p class="mt-2 text-5xl font-semibold tracking-tight text-gray-900 sm:text-6xl">
          Wähle das passende Paket für dich
        </p>
      </div>
      <p
        class="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-gray-600 sm:text-xl/8"
      >
        Wähle einen Plan, der genau zu deinen Bedürfnissen passt – egal, ob du
        dich auf eine IT-Ausbildung vorbereitest oder ein Unternehmen Azubis
        unterstützt.
      </p>
      <div
        class="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2 lg:gap-8"
      >
        <div
        ...
        >
          ...
          <p class="mt-4 flex items-baseline gap-x-2">
            ...
            <span
              :class="[tier.featured ? 'text-gray-400' : 'text-gray-500', 'text-base']"
            >
              /Monat
            </span>
          </p>
          <p
            :class="[tier.featured ? 'text-gray-300' : 'text-gray-600', 'mt-6 text-base/7']"
          >
            {{ tier.description }}
          </p>
          <ul
  ...
  const tiers = [
    {
      ...
      priceMonthly: '€19',
      description:
        'Perfekt für Azubis, die ihre IT-Ausbildung mit den besten Ressourcen starten möchten.',
      features: [
        'Zugriff auf alle Artikel',
        'Grundlagenkurse in IT und Programmierung',
        'Community-Support',
    ...
    },
    {
      ...
      priceMonthly: '€49',
      description:
        'Das ideale Paket für Unternehmen oder Azubis, die intensive Unterstützung und fortgeschrittene Inhalte suchen.',
      features: [
        'Alle Features des Starter-Plans',
        'Individuelle Lernpfade',
        'Premium-Support',
        'Zugriff auf fortgeschrittene Kurse',
        'Werkzeuge zur Zertifikatsvorbereitung',
      ],
      featured: true,
    },
  ]
